...
const OrdenesIniciadas = () => {
  ...
  const handleFinalizar = (ordenId: string) => {
    console.log('Finalizar orden:', ordenId);
    // Aquí se implementará la lógica para mover a "Ordenes Finalizadas"
  };
  ...
  const handleOrdenesRecibidas = () => {
    navigate('/ordenes-recibidas');
  };
...
export default OrdenesIniciadas;
